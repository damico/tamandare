...
public interface Constants {
	...
	public static final String SQL_JOBS_DERBY =			"CREATE TABLE TAMANDARE.JOBS (" +
	...
	public static final String[] DEFAULT_TABLES = {SQL_PREPARE_DERBY, SQL_PRESESSIONS_DERBY, SQL_HISTORYCONN_DERBY, SQL_JOBS_DERBY};
	public static final String[] DEFAULT_TABLES_NAMES = {"XMLDOCS", "PRESESSIONS", "HISTORYCONN", "JOBS"};
	...
	public static final String SQL_GET_JOBS_DERBY = "SELECT * FROM TAMANDARE.JOBS";
	public static final String SQL_ISKEEPSYNC_DERBY = "SELECT JOBS_THREAD FROM TAMANDARE.JOBS WHERE JOBS_THREAD = ?";
	public static final String SQL_DELETE_JOB_BY_NAME = "DELETE FROM TAMANDARE.JOBS WHERE JOBS_THREAD = ?";
	public static final String SQL_ADD_JOB_DERBY = "INSERT INTO TAMANDARE.JOBS (JOBS_THREAD, JOBS_INTERVAL)VALUES(?,?)";
	public static final String SQL_UPDATEKEEPSYNC_DERBY = "UPDATE TAMANDARE.JOBS SET JOBS_TIMESTAMP = ? WHERE JOBS_THREAD = ?";
